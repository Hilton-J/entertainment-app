...
const TVShows = () => {
  ...
  useEffect(() => {
    const fetchTvShows = async () => {
      const tvShowsURL = `${BASE_URL}/tvshows/discover/${currentPage}?sort=${sort}&with_genres=${selectedGenres}&country=${selectedCountry}&language=${selectedLanguage}&fromDate=${fromReleaseDate}&toDate=${toReleaseDate}`;

      const apiURL = searchQuery ? `${BASE_URL}/search/tvshows/${searchQuery}/${currentPage}` : tvShowsURL;
