      ...
      <div className="container m-auto flex justify-center">
        <div className="w-full">
          ...
          <input
            ...
            placeholder="Search"
            id="search"
            className="bg-transparent text-slate-800 border border-slate-800 focus:border-blue-600 focus:outline-none px-6 py-2 rounded-full text-sm md:text-base w-full mb-6"
